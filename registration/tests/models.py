...
class RegistrationManagerTests(test.TestCase):
    ...
    def test_gets_new_inactive_user(self):
        user = models.RegistrationProfile.objects._get_new_inactive_user("adam", "secret",
                                                                         "adam@example.com")
        self.assertFalse(user.is_active)

    @patch("registration_old.models.RegistrationProfile.objects._get_new_inactive_user")
    @patch("registration_old.models.RegistrationProfile.objects._create_profile")
    def test_creates_user_and_profile(self, create_profile, get_new_inactive_user):
        user = models.RegistrationProfile.objects.create_inactive_user("adam", "secret",
                                                                       "adam@example.com", Mock())
    ...
    @patch("registration_old.models.RegistrationProfile.objects.get")
    ...
    @patch("registration_old.models.RegistrationProfile.objects._do_activate_user")
    @patch("registration_old.models.RegistrationProfile.objects._do_activate_profile")
    @patch("registration_old.models.RegistrationProfile.objects.get")
    ...
    @patch("registration_old.models.RegistrationProfile.objects.all")
...
class RegistrationProfileModelTests(test.TestCase):
    ...
    @patch("registration_old.models.RegistrationProfile._get_activation_message")
    @patch("registration_old.models.RegistrationProfile._get_activation_subject")
    ...
    @patch('registration_old.models.User.email_user', Mock())
    @patch("registration_old.models.RegistrationProfile._get_activation_message")
    @patch("registration_old.models.RegistrationProfile._get_activation_subject")
    @patch("registration_old.models.settings")
    ...
    @patch("registration_old.models.render_to_string")
