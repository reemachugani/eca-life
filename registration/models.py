...
class RegistrationManager(models.Manager):
    ...
    def create_inactive_user(self, first_name, last_name, username, password, email,
        ...
        new_user = self._get_new_inactive_user( first_name, last_name, username, password, email)
    ...
    def _get_new_inactive_user(self, first_name, last_name, username, password, email):
...
class RegistrationProfile(models.Model):
    ...
    def _get_activation_message(self, site):
        link = 'http://%s/accounts/activate/%s/' %(settings.SITE_HOST, self.activation_key)
